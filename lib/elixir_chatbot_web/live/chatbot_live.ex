defmodule ElixirChatbotWeb.ChatbotLive do
  ...
  @impl true
  def handle_info({ElixirChatbotWeb.ChatbotLive.FormComponent, {:saved, message}}, socket) do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col flex-grow w-full max-w-xl bg-white shadow-xl rounded-t-lg overflow-hidden">
      ...
      <div class="bg-gray-300 p-4">
        <.live_component
          module={ElixirChatbotWeb.ChatbotLive.FormComponent}
          id="new-message"
